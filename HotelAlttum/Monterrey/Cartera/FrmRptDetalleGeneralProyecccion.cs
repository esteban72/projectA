...
{
    public partial class FrmRptDetalleGeneralProyecccion : Form
    {
        public FrmRptDetalleGeneralProyecccion()
        {
            InitializeComponent();
        }
        ...
        private void FrmRptDetalleGeneralProyecccion_Load(object sender, EventArgs e)
        {
            this.rptproyecciondetalleTableAdapter.Connection.ConnectionString = FrmLogeo.StrConexion;
            // TODO: esta línea de código carga datos en la tabla 'carteraDataSet.rptproyecciondetalle' Puede moverla o quitarla según sea necesario.
...
//===================================================================================================================================================
        public void MtdDatosObra()
        {
            ...
            //System.Data.DataTable MisUsuarios = FrmLogeo.DsGenerales.Tables["Obras"];
            //var query = (
